...
class AlamofireAdapterTests: XCTestCase {
    ...
    func test_post_should_complete_with_error_when_response_completes_with_error(){
...
extension AlamofireAdapterTests {
    ...
    func expectResult(_ expectedResult: Result<Data?, HttpError>,
        ...
        sut.post(to: makeUrl(), with: makeValidData()) { receiveResult in
            ...
            case (.success(let expectedData), .success(let receiveData)): XCTAssertEqual(expectedData, receiveData, file: file, line: line)
            default: XCTFail("Expected \(expectedResult) got \(receiveResult) instead", file: file, line: line)
            }
